    ...
    <div className="home-landing-page">
      ...
      <div className="home-carousel">
        <Carousel arrows prevArrow={<ArrowCarousel type="pre" />} nextArrow={<ArrowCarousel />}>
          ...
          <div>
            <Row justify={'space-around'} style={{ backgroundColor: '#FFE9BE' }}>
              <Col lg={9} md={24} className='content'>
                <div className='minute'>
                  <Typography.Title level={1}>Protect your legacy in Minutes</Typography.Title>
                </div>
      ...
      <Row className='mask-group' style={{}}>
        ...
        <Col className='mask-right'>
          ...
          <span className='kk47tXa'>Free uploading of signed Will into the platform</span>
          <div>
      ...
      <div className='home_5167844'>
        ...
        <div className='g2KuLzz'>
          <Home_5168635 />
          <h4>Smart, savvy way of creating and managing your Will in 3 simple steps</h4>
      ...
      <Row className="jjRTz9U2 qqF2J1H">
        ...
        <Col md={{ span: 18 }} xl={{ span: 7, offset: 2 }} className='home-kz12'>
          <h5>Step 1</h5>
          <h3>Will Creation</h3>
          <h6>Seamless and simple Will writing experience with relevant insights to guide you. </h6>
          <h4><h4 className='home-kz12-h4'>Express document toggle </h4>for drafting of Basic Will in minutes.</h4>
        </Col>
      </Row>
      <Row className="jjRTz9U2" justify='center' style={{ flexDirection: 'row-reverse' }}>
        <Col lg={{ offset: 3 }} className="kZ7t2Rf2" >
          <HomeStep2 />
          <HomeStep2Mini />
        </Col>
        <Col md={18} xl={6} className='home-kz12'>
          <h5>Step 2</h5>
          <h3>Upload Securely</h3>
          <h6>A secured interface with your data encrypted and your Will stored safely to protect your privacy. </h6>
          <h4 style={{ backgroundColor: '#E0F6EF' }}><h4 className='home-kz12-h4'>256-Bit Security System </h4>for quick Will crafting, so go and finish the Will fast!</h4>
        </Col>
      </Row>
      <Row className="jjRTz9U2">
        ...
        <Col md={18} lg={18} xl={{ span: 6, offset: 3 }} className='home-kz12'>
          <h5>Step 3</h5>
          <h3>Manage Your Will</h3>
          <h6>Access and update your Will anytime, and manage your legacy with your personalised dashboard.</h6>
          <h4 style={{ backgroundColor: '#FAECEC' }}><h4 className='home-kz12-h4'>Plan and manage </h4>your legacy holistically.</h4>
        </Col>
      </Row>
      <Row align='middle' justify='space-between' className='did-you-know'>
        <Col md={8} xs={24} className="lkk4KUz">
          <HomeShield />
        </Col>
