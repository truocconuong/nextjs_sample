        ...
        <div className='home-landing-page'>
            ...
            <div className='home-carousel'>
                    ...
                    <div>
                        ...
                        >
                            <Col lg={9} md={24} className='content'>
                                ...
                                <h5>
                                    Will-writing made affordable and accessible
                                    to everyone with someone who matters
                                </h5>
                                <CustomButton
                                    size='large'
                                    borderLarge
                ...
                <Row className='home-5167832'>
                    ...
                    <Col lg={15} md={24} xs={24} sm={24}>
                        ...
                        <h6>
                            Writing a Will and leaving a legacy is commonly
                            associated with vast fortune, however, even those
                            without vast wealth will need to consider a writing
                            a Will so that your loved ones' standards of living
                            will not be disrupted in your absence.
                        </h6>
                    </Col>
                    <Col>
            ...
            <div className='home-5168517'>
                <Typography.Title level={3}>
                    Empowering you to manage your Will and legacy at your
                    fingertips
                </Typography.Title>
            ...
            <Row className='mask-group' style={{}}>
                <Col className='mask-left'>
                    ...
                    <p>
                        All you need to do is simply to create, upload & manage.
                    </p>
                    <CustomButton
                        borderLarge
                        fontWeightLarge
                ...
                <Col className='mask-right'>
                    <Home_5168374 />
                    <p>
                        The platform fees is to help us cover our cost incurred
                        from maintaining a secured and safe environment for you
                        to regularly review and onClick={handleCreateYourWill}{' '}
                        create your Will and manage your legacy.
                    </p>
                    ...
                    <div className='klkl55T'>
                        ...
                        <span>
                            {' '}
                            of Will as data entered will be encrypted and stored
                        </span>
                    </div>
                    ...
                    <div>
                        <span>
                            Access to Legacy Planner Dashboard to manage your
                            legacy
                        </span>
                    </div>
                    <CustomButton
            ...
            <div className='home_5167844'>
                ...
                <div className='g2KuLzz'>
                    <Home_5168635 />
                    <h4>
                        Smart, savvy way of creating and managing your Will in 3
                        simple steps
                    </h4>
                    <h5>
                        All you need to do is simply to create, upload & manage.
            ...
            <Row className='jjRTz9U2' justify={'space-around'}>
                ...
                <Col md={{ span: 18 }} xl={{ span: 7 }} className='home-kz12'>
                    ...
                    <h3>Will Creation</h3>
                    <h6>
                        Seamless and simple Will writing experience with
                        relevant insights to guide you.{' '}
                    </h6>
                    <h4>
                        <h4 className='home-kz12-h4'>
                            Express document toggle{' '}
                        </h4>
            ...
            <Row className='jjRTz9U2' justify={'space-around'}>
                ...
                <Col md={18} lg={18} xl={{ span: 7 }} className='home-kz12'>
                    ...
                    <h6>
                        Access and update your Will anytime, and manage your
                        legacy with your personalised dashboard.
                    </h6>
                    <h4 style={{ backgroundColor: '#FAECEC' }}>
                        <h4 className='home-kz12-h4'>Plan and manage </h4>your
                        legacy holistically.
                    </h4>
                </Col>
            </Row>
                    ...
                    >
                        ...
                        >
                            <p>
                                ...
                                volutpat lacus laoreet non. Ac turpis egestas
                                sed tempus urna et pharetra pharetra.
                                Scelerisque varius morbi enim nunc faucibus a
                                pellentesque sit. Elementum curabitur vitae nunc
                                sed.{' '}
                            </p>
                        </Panel>
                        <Panel
                        ...
                        >
                            <p>
                                Lorem ipsum dolor sit amet, consectetur
                                adipiscing elit, sed do eiusmod ? Ac turpis
