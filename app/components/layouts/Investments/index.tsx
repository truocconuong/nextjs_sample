          ...
          <Row className="main-investment">
            ...
            <Col className="input-investment">
              {listData.length > 0 && listData.map((item, index) => {
                return (
                  <Row
                    className="form-investment mb-32"
                    style={{padding: "21px 32px"}}
                  >
                    <Row justify="space-between" align="middle">
                      <Col className="div-center">
                        ...
                        <Col>
                          ...
                          <Row>
                            <span className="financial">{item?.financial}</span>
                          </Row>
                        </Col>
                      </Col>
                      <Col className="div-center">
              ...
              <Row className="add-investment" justify="space-between">
                <CloudIcon />
                <span onClick={handleAddInvestment} style={{cursor: 'pointer'}}>Add Investment</span>
              </Row>
            </Col>
          </Row>
        </Row>
